  ...
  printBenefitDetails(
    ...
    if (
      ...
      return;
		...
		if (dateDiscount > 0) Console.print(`크리스마스 디데이 할인: -${dateDiscount.toLocaleString('ko-KR')}원`);
		...
		if (starDiscount > 0) Console.print(`특별 할인: -${starDiscount.toLocaleString('ko-KR')}원`);
		if (giveawayDiscount > 0) Console.print(`증정 이벤트: -${giveawayDiscount.toLocaleString('ko-KR')}원`);
	},
